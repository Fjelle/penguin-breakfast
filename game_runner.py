import player, ai_player, ai_developer, company, game_manager,pdb
...
def main():
    ...
    player_amount=0
    ai_amount=2
    jump_array=[-0.1,0,0.1]   #the ai's behaviour is tested around it's current value with this list.
    ai2_behaviour=[2,2,2,2]   #the behaviour of the ai to improve against



    for jumpcounter in range(0,200): #repeat for how many times the program should try to improve the ai
            ...
            for xx in jump_array:
                for yy in jump_array:
                    for zz in jump_array:
                        ...
                        for game_counter in range(0,150):
